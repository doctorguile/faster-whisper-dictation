...
def parse_args():
    parser = argparse.ArgumentParser(
        description='Dictation app using the Faster whisper. By default the keyboard shortcut cmd+option '
    ...
    parser.add_argument('-m', '--model_name', type=str,
                        ...
                        help='Size of the model to use (tiny, tiny.en, base, base.en,'
                             ...
                             'from the Hugging Face Hub. Default: base.')
    parser.add_argument('-k', '--key_combination', type=str,
                        help='Specify the key combination to toggle the app. Example: cmd_l+alt for macOS '
                             'ctrl+alt for other platforms. Default: ctrl+alt on all systems except macOS (see below).')
    parser.add_argument('--k_double_cmd', action='store_true', default=True,
                        help='If key_combination is not set, on macOS default to use double Right Command key press to toggle the app'
                             ' (double click to begin recording, single click to stop recording).')
    parser.add_argument('-l', '--language', type=str, default=None,
                        help='Specify the two-letter language code (e.g., "en" for English) to improve recognition accuracy. '
                        'This can be especially helpful for smaller model sizes.')
...
if __name__ == "__main__":
    ...
    if not args.key_combination or (args.k_double_cmd or platform.system() == 'Darwin'):
        key_listener = DoubleCommandKeyListener(app)
    else:
        key_listener = GlobalKeyListener(app, args.key_combination or 'ctrl+alt')
